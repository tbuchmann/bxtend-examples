 ...
 * </p>
 * <ul>
 *   <li>{@link de.tbuchmann.bxtend.ecore2sql.correspondence.ecore2sql.impl.TransformationImpl#getCorrespondences <em>Correspondences</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransformationImpl extends EObjectImpl implements Transformation {
	...
	protected EClass eStaticClass() {
		return Ecore2sqlPackage.Literals.TRANSFORMATION;
	}
	...
	public EList<Corr> getCorrespondences() {
		if (correspondences == null) {
			correspondences = new EObjectContainmentEList<Corr>(Corr.class, this, Ecore2sqlPackage.TRANSFORMATION__CORRESPONDENCES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ecore2sqlPackage.TRANSFORMATION__CORRESPONDENCES:
