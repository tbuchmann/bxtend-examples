 ...
 * @generated
 */
public class Ecore2sqlPackageImpl extends EPackageImpl implements Ecore2sqlPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see de.tbuchmann.bxtend.ecore2sql.correspondence.ecore2sql.Ecore2sqlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Ecore2sqlPackageImpl() {
		super(eNS_URI, Ecore2sqlFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link Ecore2sqlPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Ecore2sqlPackage init() {
		if (isInited) return (Ecore2sqlPackage)EPackage.Registry.INSTANCE.getEPackage(Ecore2sqlPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredEcore2sqlPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		Ecore2sqlPackageImpl theEcore2sqlPackage = registeredEcore2sqlPackage instanceof Ecore2sqlPackageImpl ? (Ecore2sqlPackageImpl)registeredEcore2sqlPackage : new Ecore2sqlPackageImpl();
		...
		theEcore2sqlPackage.createPackageContents();

		// Initialize created meta-data
		theEcore2sqlPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theEcore2sqlPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Ecore2sqlPackage.eNS_URI, theEcore2sqlPackage);
		return theEcore2sqlPackage;
	}
	 ...
	 */
	@Override
	public Ecore2sqlFactory getEcore2sqlFactory() {
		return (Ecore2sqlFactory)getEFactoryInstance();
	}
