...
import de.tbuchmann.bxtend.set2oset.correspondence.set2oset.BasicElem;
 ...
 * @generated
 */
public class Set2osetPackageImpl extends EPackageImpl implements Set2osetPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see de.tbuchmann.bxtend.set2oset.correspondence.set2oset.Set2osetPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Set2osetPackageImpl() {
		super(eNS_URI, Set2osetFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link Set2osetPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Set2osetPackage init() {
		if (isInited) return (Set2osetPackage)EPackage.Registry.INSTANCE.getEPackage(Set2osetPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredSet2osetPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		Set2osetPackageImpl theSet2osetPackage = registeredSet2osetPackage instanceof Set2osetPackageImpl ? (Set2osetPackageImpl)registeredSet2osetPackage : new Set2osetPackageImpl();
		...
		theSet2osetPackage.createPackageContents();

		// Initialize created meta-data
		theSet2osetPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theSet2osetPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Set2osetPackage.eNS_URI, theSet2osetPackage);
		return theSet2osetPackage;
	}
	 ...
	 */
	@Override
	public Set2osetFactory getSet2osetFactory() {
		return (Set2osetFactory)getEFactoryInstance();
	}
