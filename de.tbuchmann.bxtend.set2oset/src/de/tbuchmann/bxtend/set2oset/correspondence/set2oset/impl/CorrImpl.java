 ...
 * </p>
 * <ul>
 *   <li>{@link de.tbuchmann.bxtend.set2oset.correspondence.set2oset.impl.CorrImpl#getSourceElement <em>Source Element</em>}</li>
 *   <li>{@link de.tbuchmann.bxtend.set2oset.correspondence.set2oset.impl.CorrImpl#getTargetElement <em>Target Element</em>}</li>
 *   <li>{@link de.tbuchmann.bxtend.set2oset.correspondence.set2oset.impl.CorrImpl#getDesc <em>Desc</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CorrImpl extends EObjectImpl implements Corr {
	...
	protected EClass eStaticClass() {
		return Set2osetPackage.Literals.CORR;
	}
		...
		if (sourceElement != null && sourceElement.eIsProxy()) {
			...
			if (sourceElement != oldSourceElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Set2osetPackage.CORR__SOURCE_ELEMENT, oldSourceElement, sourceElement));
			}
		}
	...
	public void setSourceElement(EObject newSourceElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Set2osetPackage.CORR__SOURCE_ELEMENT, oldSourceElement, sourceElement));
	}
	...
	public EObject getTargetElement() {
		if (targetElement != null && targetElement.eIsProxy()) {
			...
			if (targetElement != oldTargetElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Set2osetPackage.CORR__TARGET_ELEMENT, oldTargetElement, targetElement));
			}
		}
	...
	public void setTargetElement(EObject newTargetElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Set2osetPackage.CORR__TARGET_ELEMENT, oldTargetElement, targetElement));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Set2osetPackage.CORR__DESC, oldDesc, desc));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Set2osetPackage.CORR__SOURCE_ELEMENT:
				if (resolve) return getSourceElement();
				return basicGetSourceElement();
			case Set2osetPackage.CORR__TARGET_ELEMENT:
				if (resolve) return getTargetElement();
				return basicGetTargetElement();
			case Set2osetPackage.CORR__DESC:
				return getDesc();
		}
