 ...
 * </p>
 * <ul>
 *   <li>{@link de.tbuchmann.bxtend.bag12bag2.correspondence.bag12bag2.impl.CorrImpl#getSourceElement <em>Source Element</em>}</li>
 *   <li>{@link de.tbuchmann.bxtend.bag12bag2.correspondence.bag12bag2.impl.CorrImpl#getTargetElement <em>Target Element</em>}</li>
 *   <li>{@link de.tbuchmann.bxtend.bag12bag2.correspondence.bag12bag2.impl.CorrImpl#getDesc <em>Desc</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CorrImpl extends EObjectImpl implements Corr {
	...
	protected EClass eStaticClass() {
		return Bag12bag2Package.Literals.CORR;
	}
		...
		if (sourceElement != null && sourceElement.eIsProxy()) {
			...
			if (sourceElement != oldSourceElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bag12bag2Package.CORR__SOURCE_ELEMENT, oldSourceElement, sourceElement));
			}
		}
	...
	public void setSourceElement(EObject newSourceElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bag12bag2Package.CORR__SOURCE_ELEMENT, oldSourceElement, sourceElement));
	}
	...
	public EObject getTargetElement() {
		if (targetElement != null && targetElement.eIsProxy()) {
			...
			if (targetElement != oldTargetElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bag12bag2Package.CORR__TARGET_ELEMENT, oldTargetElement, targetElement));
			}
		}
	...
	public void setTargetElement(EObject newTargetElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bag12bag2Package.CORR__TARGET_ELEMENT, oldTargetElement, targetElement));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bag12bag2Package.CORR__DESC, oldDesc, desc));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bag12bag2Package.CORR__SOURCE_ELEMENT:
				if (resolve) return getSourceElement();
				return basicGetSourceElement();
			case Bag12bag2Package.CORR__TARGET_ELEMENT:
				if (resolve) return getTargetElement();
				return basicGetTargetElement();
			case Bag12bag2Package.CORR__DESC:
				return getDesc();
		}
