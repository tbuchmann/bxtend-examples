 ...
 * </p>
 * <ul>
 *   <li>{@link de.tbuchmann.bxtend.pdb12pdb2.correspondence.pdb12pdb2.impl.TransformationImpl#getCorrespondences <em>Correspondences</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransformationImpl extends EObjectImpl implements Transformation {
	...
	protected EClass eStaticClass() {
		return Pdb12pdb2Package.Literals.TRANSFORMATION;
	}
	...
	public EList<Corr> getCorrespondences() {
		if (correspondences == null) {
			correspondences = new EObjectContainmentEList<Corr>(Corr.class, this, Pdb12pdb2Package.TRANSFORMATION__CORRESPONDENCES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pdb12pdb2Package.TRANSFORMATION__CORRESPONDENCES:
