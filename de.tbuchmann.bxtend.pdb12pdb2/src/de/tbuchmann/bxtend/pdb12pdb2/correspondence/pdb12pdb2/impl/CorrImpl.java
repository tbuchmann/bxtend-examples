 ...
 * </p>
 * <ul>
 *   <li>{@link de.tbuchmann.bxtend.pdb12pdb2.correspondence.pdb12pdb2.impl.CorrImpl#getSourceElement <em>Source Element</em>}</li>
 *   <li>{@link de.tbuchmann.bxtend.pdb12pdb2.correspondence.pdb12pdb2.impl.CorrImpl#getTargetElement <em>Target Element</em>}</li>
 *   <li>{@link de.tbuchmann.bxtend.pdb12pdb2.correspondence.pdb12pdb2.impl.CorrImpl#getDesc <em>Desc</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CorrImpl extends EObjectImpl implements Corr {
	...
	protected EClass eStaticClass() {
		return Pdb12pdb2Package.Literals.CORR;
	}
		...
		if (sourceElement != null && sourceElement.eIsProxy()) {
			...
			if (sourceElement != oldSourceElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Pdb12pdb2Package.CORR__SOURCE_ELEMENT, oldSourceElement, sourceElement));
			}
		}
	...
	public void setSourceElement(EObject newSourceElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pdb12pdb2Package.CORR__SOURCE_ELEMENT, oldSourceElement, sourceElement));
	}
	...
	public EObject getTargetElement() {
		if (targetElement != null && targetElement.eIsProxy()) {
			...
			if (targetElement != oldTargetElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Pdb12pdb2Package.CORR__TARGET_ELEMENT, oldTargetElement, targetElement));
			}
		}
	...
	public void setTargetElement(EObject newTargetElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pdb12pdb2Package.CORR__TARGET_ELEMENT, oldTargetElement, targetElement));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pdb12pdb2Package.CORR__DESC, oldDesc, desc));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pdb12pdb2Package.CORR__SOURCE_ELEMENT:
				if (resolve) return getSourceElement();
				return basicGetSourceElement();
			case Pdb12pdb2Package.CORR__TARGET_ELEMENT:
				if (resolve) return getTargetElement();
				return basicGetTargetElement();
			case Pdb12pdb2Package.CORR__DESC:
				return getDesc();
		}
