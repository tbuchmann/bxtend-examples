...
interface TargetToSourceDecision {
	 ...
	 *         brand-new Family
	 */
	def Family getFamily(List<Family> families, Person person, Family actualFamily);
	 ...
	 */
	def boolean setAsParent(Person person, Family family);
	 ...
	 */
	def boolean deleteEmptyFamily(Family family, FamilyMember lastMember);
	 ...
	 */
	def void linkPersonToFamily(Person person, Family family)
}