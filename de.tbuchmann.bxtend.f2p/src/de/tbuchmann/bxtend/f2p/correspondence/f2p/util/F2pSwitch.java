/**
 */
package de.tbuchmann.bxtend.f2p.correspondence.f2p.util;
 ...
 * @generated
 */
public class F2pSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static F2pPackage modelPackage;
	...
	public F2pSwitch() {
		if (modelPackage == null) {
			modelPackage = F2pPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case F2pPackage.TRANSFORMATION: {
				Transformation transformation = (Transformation)theEObject;
				T result = caseTransformation(transformation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case F2pPackage.CORR: {
				Corr corr = (Corr)theEObject;
				T result = caseCorr(corr);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case F2pPackage.BASIC_ELEM: {
