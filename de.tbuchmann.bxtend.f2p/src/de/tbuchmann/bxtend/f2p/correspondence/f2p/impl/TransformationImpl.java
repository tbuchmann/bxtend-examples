 ...
 * </p>
 * <ul>
 *   <li>{@link de.tbuchmann.bxtend.f2p.correspondence.f2p.impl.TransformationImpl#getCorrespondences <em>Correspondences</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransformationImpl extends EObjectImpl implements Transformation {
	...
	protected EClass eStaticClass() {
		return F2pPackage.Literals.TRANSFORMATION;
	}
	...
	public EList<Corr> getCorrespondences() {
		if (correspondences == null) {
			correspondences = new EObjectContainmentEList<Corr>(Corr.class, this, F2pPackage.TRANSFORMATION__CORRESPONDENCES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case F2pPackage.TRANSFORMATION__CORRESPONDENCES:
