 ...
 * </p>
 * <ul>
 *   <li>{@link de.tbuchmann.bxtend.pn2pnw.correspondence.pn2pnw.impl.TransformationImpl#getCorrespondences <em>Correspondences</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransformationImpl extends EObjectImpl implements Transformation {
	...
	protected EClass eStaticClass() {
		return Pn2pnwPackage.Literals.TRANSFORMATION;
	}
	...
	public EList<Corr> getCorrespondences() {
		if (correspondences == null) {
			correspondences = new EObjectContainmentEList<Corr>(Corr.class, this, Pn2pnwPackage.TRANSFORMATION__CORRESPONDENCES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pn2pnwPackage.TRANSFORMATION__CORRESPONDENCES:
