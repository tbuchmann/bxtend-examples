 ...
 * @generated
 */
public class Pn2pnwPackageImpl extends EPackageImpl implements Pn2pnwPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see de.tbuchmann.bxtend.pn2pnw.correspondence.pn2pnw.Pn2pnwPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Pn2pnwPackageImpl() {
		super(eNS_URI, Pn2pnwFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link Pn2pnwPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Pn2pnwPackage init() {
		if (isInited) return (Pn2pnwPackage)EPackage.Registry.INSTANCE.getEPackage(Pn2pnwPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredPn2pnwPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		Pn2pnwPackageImpl thePn2pnwPackage = registeredPn2pnwPackage instanceof Pn2pnwPackageImpl ? (Pn2pnwPackageImpl)registeredPn2pnwPackage : new Pn2pnwPackageImpl();
		...
		thePn2pnwPackage.createPackageContents();

		// Initialize created meta-data
		thePn2pnwPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		thePn2pnwPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Pn2pnwPackage.eNS_URI, thePn2pnwPackage);
		return thePn2pnwPackage;
	}
	 ...
	 */
	@Override
	public Pn2pnwFactory getPn2pnwFactory() {
		return (Pn2pnwFactory)getEFactoryInstance();
	}
