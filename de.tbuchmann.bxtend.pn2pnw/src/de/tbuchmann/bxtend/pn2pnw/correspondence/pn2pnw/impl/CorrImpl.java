...
import de.tbuchmann.bxtend.pn2pnw.correspondence.pn2pnw.Pn2pnwPackage;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.tbuchmann.bxtend.pn2pnw.correspondence.pn2pnw.impl.CorrImpl#getSourceElement <em>Source Element</em>}</li>
 *   <li>{@link de.tbuchmann.bxtend.pn2pnw.correspondence.pn2pnw.impl.CorrImpl#getTargetElement <em>Target Element</em>}</li>
 *   <li>{@link de.tbuchmann.bxtend.pn2pnw.correspondence.pn2pnw.impl.CorrImpl#getDesc <em>Desc</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CorrImpl extends EObjectImpl implements Corr {
	...
	protected EClass eStaticClass() {
		return Pn2pnwPackage.Literals.CORR;
	}
		...
		if (sourceElement != null && sourceElement.eIsProxy()) {
			...
			if (sourceElement != oldSourceElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Pn2pnwPackage.CORR__SOURCE_ELEMENT, oldSourceElement, sourceElement));
			}
		}
	...
	public void setSourceElement(EObject newSourceElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pn2pnwPackage.CORR__SOURCE_ELEMENT, oldSourceElement, sourceElement));
	}
	...
	public EObject getTargetElement() {
		if (targetElement != null && targetElement.eIsProxy()) {
			...
			if (targetElement != oldTargetElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Pn2pnwPackage.CORR__TARGET_ELEMENT, oldTargetElement, targetElement));
			}
		}
	...
	public void setTargetElement(EObject newTargetElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pn2pnwPackage.CORR__TARGET_ELEMENT, oldTargetElement, targetElement));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pn2pnwPackage.CORR__DESC, oldDesc, desc));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pn2pnwPackage.CORR__SOURCE_ELEMENT:
				if (resolve) return getSourceElement();
				return basicGetSourceElement();
			case Pn2pnwPackage.CORR__TARGET_ELEMENT:
				if (resolve) return getTargetElement();
				return basicGetTargetElement();
			case Pn2pnwPackage.CORR__DESC:
				return getDesc();
		}
