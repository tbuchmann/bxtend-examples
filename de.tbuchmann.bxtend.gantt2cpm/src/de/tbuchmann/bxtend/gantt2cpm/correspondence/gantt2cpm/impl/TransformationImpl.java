 ...
 * </p>
 * <ul>
 *   <li>{@link de.tbuchmann.bxtend.gantt2cpm.correspondence.gantt2cpm.impl.TransformationImpl#getCorrespondences <em>Correspondences</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransformationImpl extends EObjectImpl implements Transformation {
	...
	protected EClass eStaticClass() {
		return Gantt2cpmPackage.Literals.TRANSFORMATION;
	}
	...
	public EList<Corr> getCorrespondences() {
		if (correspondences == null) {
			correspondences = new EObjectContainmentEList<Corr>(Corr.class, this, Gantt2cpmPackage.TRANSFORMATION__CORRESPONDENCES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Gantt2cpmPackage.TRANSFORMATION__CORRESPONDENCES:
